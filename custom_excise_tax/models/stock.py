...
class stock_quant_inherit(models.Model):
    ...
    product_volume = fields.Float(related='product_id.product_tmpl_id.volume', string="Volume (L)")
    product_alcohol_volume = fields.Float(related='product_id.product_tmpl_id.alcohol_volume', string="Alcohol Vol. (%)")
    product_alcohol_100_volume = fields.Float(related='product_id.product_tmpl_id.alcohol_100_volume', string="Alcohol Vol. (real)")
